                                    ...
                                    <div class="single-product-image-inner">
                                        <div id="product-images1" class="slider-for" data-slick='{"slidesToShow" : 1, "slidesToScroll": 1, "infinite" : false, "asNavFor" : ".slider-nav" }'>
                                            <div class="woocommerce-image-zoom">
                                                <img width="600" height="600" src="../../wp-content/uploads/2017/09/product15.jpg" class="attachment-shop_single size-shop_single" alt="" loading="lazy" srcset="https://demo.harutheme.com/clarivo/wp-content/uploads/2017/09/product15.jpg 600w, https://demo.harutheme.com/clarivo/wp-content/uploads/2017/09/product15-100x100.jpg 100w, https://demo.harutheme.com/clarivo/wp-content/uploads/2017/09/product15-150x150.jpg 150w, https://demo.harutheme.com/clarivo/wp-content/uploads/2017/09/product15-300x300.jpg 300w, https://demo.harutheme.com/clarivo/wp-content/uploads/2017/09/product15-270x270.jpg 270w, https://demo.harutheme.com/clarivo/wp-content/uploads/2017/09/product15-540x540.jpg 540w" sizes="(max-width: 600px) 100vw, 600px" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="summary entry-summary">
                                    <h1 class="product_title entry-title">ALECENSA 150MG CAPSULE</h1>
                                    <div class="product_meta">
                                        <span class="posted_in">
                                            <span class="label">Product Chemical :</span> 
                                            <a href="#" rel="tag">ALECTINIB 150MG</a>
                                        </span>
                                        <span class="posted_in">
                                            <span class="label">Product Form :</span> 
                                            <a href="#" rel="tag">CAPSULE</a>
                                        </span>
                                        <span class="tagged_as">
                                            <span class="label">Company Name :</span>
                                            <a href="#" rel="tag">ROCHE PRODUCTS INDIA PVT LTD.</a>
                                        </span>
                                        <span class="tagged_as">
                                        ...
                                        <span class="tagged_as">
                                            ...
                                            <a href="#" rel="tag">224 CAPSULE</a>
                                        </span>
                                        <span class="tagged_as">
                                            <span class="label">Product Category :</span>
                                            <a href="#" rel="tag">ANTI CANCER CAPSULES</a>
                                        </span>
                                    </div>
                                </div><!-- .summary -->
                            </div>
