...
<div id="haru-content-main" class="clearfix">
    <div class="haru-page-title-section" style="background-image: url(../wp-content/themes/clarivo/framework/admin-assets/images/theme-options/bg-page-title.jpg)">
        ...
        <div class="haru-breadcrumb-wrapper">
            <div class="container">
                <ul class="breadcrumbs"><li><a href="index.php" class="home">Home</a></li><li><a href="category.php" class="home">Category</a></li><li><span>Sub Category</span></li></ul>
            </div>
        </div>
    </div>
    ...
    <div class="vc_column-inner">
        <div class="wpb_wrapper">
            <h1 style="font-size: 30px;color: #18a0b1;text-align: center; margin-bottom: 20px;" class="vc_custom_heading heading_style_1">Sub Category</h1>
        </div>
    </div>
                                                        ...
                                                        <div class="wpb_wrapper">
                                                            <div class=" ">
                                                                <div class="products-shortcode-wrap grid">
                                                                    <ul class="row products shortcode-product-columns-5">
                                                                        <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12 clearfix product type-product post-69 status-publish first instock product_cat-tablet product_tag-powder product_tag-solution product_tag-spray product_tag-suppository product_tag-syrup product_tag-tablet has-post-thumbnail sale taxable shipping-taxable purchasable product-type-variable" style="width:300px;">
                                                                            <div class="product-inner">
                                                                               <div class="product-info">
                                                                                    <a href="#" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                                                        <div class="card-header text-center"><p class="card-title" style="color:#048a9a;font-size:1.0em;"><br><b><?php echo $row['Product_Name']; ?></b></p></div>
                                                                                    </a>
                                                                                ...
                                                                                <div class="product-info">
                                                                                    <a href="#" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                                                        <div class="card-header text-center"><p class="card-title" style="color:#048a9a;font-size:1.0em;"><span style="color:#ed6f1e;"><b><?php echo $row['category_name']; ?></b></span></p></div>
                                                                                    </a>
                                                                                    <div class="product-short-description">
                                                                                    </div>
                                                                                </div>
